const findActaNumero = document.getElementById("myform");

findActaNumero.addEventListener('submit', (event) => {
  event.preventDefault();

  const numeroActa = document.getElementById("nroMesa").value
  getActasPorNumero(numeroActa)
})


const getActasPorNumero = async (numeroActa) => {

    const data = await fetch(`https://oaemdl.es/onpe_sweb_php/actas/numero/${numeroActa}`)

     if ( data.status == 200 ) {
        
        const acta = await data.json()
        let html = document.getElementById('divDetalle') 
        const element = acta.data;
          ...
          `<div class="contenido-resultados">
                    ...
                    <div class="row">
                      ...
                      <div class="tab-info">${acta.message}</div>
                                      ...
                                      <div class="col-xs-12">
                                        ...
                                        <div id="page-wrap">
                                          <table class="table13" cellspacing="0">
                                            ...
                                            <tbody>
                                              <tr>
                                                <td>${element.idGrupoVotacion}</td>
                                                <td>${element.nCopia}</td>
                                              </tr>
                                            </tbody>
                                          </table>
                                        </div>
                                        ...
                                        <div id="page-wrap">
                                          <table class="table15" cellspacing="0">
                                            <tbody>
                                              ...
                                              <tr>
                                                <td>${element.ElectoresHabiles}</td>
                                                <td>${element.TotalVotantes}</td>
